...
exports.getCourse = asyncHandler( async (req, res, next) => {
  ...
  if(!course) {
    return next(new ErrorResponse(`No course with th id of ${req.params.id}`), 404);
  }
...
req.body.user = req.user.id;
  ...
  if(!bootcamp) {
    return next(new ErrorResponse(`No bootcamp with th id of ${req.params.bootcampId}`), 404);
  }
